...
import fotoCapa from 'assets/minha_foto.jpg'
import fotoAboutMe from 'assets/minha_foto.jpg'
  ...
  return (
    ...
    >
      <h3 className={styles.subtitulo}>
        Hello Im Jaime Filho
      </h3>
      <img src={fotoAboutMe} alt='jaime' className={styles.fotoSobreMim} />
